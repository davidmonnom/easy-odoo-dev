...
(function (exports) {
  ...
  class TemplateSet {
    constructor(config = {}) {
      ...
      this.runtimeUtils = {
        ...helpers,
        __globals__: config.globalValues || {},
      };
      this.hasGlobalValues = Boolean(
        config.globalValues && Object.keys(config.globalValues).length
      );
    }
  ...
  class CodeGenerator {
    ...
    compileTDomNode(ast, ctx) {
      ...
      for (let key in ast.attrs) {
        ...
        if (key.startsWith("t-attf")) {
          ...
          const attrTranslationCtx =
            ((_a = ast.attrsTranslationCtx) === null || _a === void 0
              ? void 0
              : _a[key]) || ctx.translationCtx;
      ...
      if (ast.body) {
        ...
        if (ast.defaultValue) {
          const defaultValue = toStringExpression(
            ctx.translate
              ? this.translate(ast.defaultValue, ctx.translationCtx)
              : ast.defaultValue
          );
          if (ast.value) {
    ...
    formatProp(name, value, attrsTranslationCtx, translationCtx) {
      if (name.endsWith(".translate")) {
        const attrTranslationCtx =
          (attrsTranslationCtx === null || attrsTranslationCtx === void 0
            ? void 0
            : attrsTranslationCtx[name]) || translationCtx;
  ...
  function parseTCustom(node, ctx) {
    ...
    for (let attr of nodeAttrsNames) {
      if (attr === "t-custom" || attr === "t-custom-") {
        throw new OwlError(
          "Missing custom directive name with t-custom directive"
        );
      }
      if (attr.startsWith("t-custom-")) {
        ...
        if (!customDirective) {
          throw new OwlError(
            `Custom directive "${directiveName}" is not defined`
          );
        }
  ...
  function parseTTranslation(node, ctx) {
    ...
    if (
      (result === null || result === void 0 ? void 0 : result.type) ===
      3 /* Multi */
    ) {
  ...
  function parseTTranslationContext(node, ctx) {
    ...
    if (
      ...
      const children = result.content.map((c) =>
        wrapInTTranslationContextAST(c, translationCtx)
      );
      return makeASTMulti(children);
    }
